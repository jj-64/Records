...
```{r}
feature_only$regime = regime

train_idx <- createDataPartition(regime, p = 0.7, list = FALSE)
...
selected_features2 <- c( "garch_acf", "garch_r2",
...
6.2 Performance evaluation
```{r}
pred_clean <- predict(clean, newdata = test_clean)
