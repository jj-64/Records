...
## file name if saving
file_name = paste0("Simulation_DTRW_Rn_overT_unif_max=",max_obs,"_biasCorrected.xlsx")
###########################  Simulation  ###########################
...
if(save){
  ## Save the workbook
  saveWorkbook(wb, paste0("data/param_est/DTRW/unif/records/",file_name), overwrite = TRUE)
}
