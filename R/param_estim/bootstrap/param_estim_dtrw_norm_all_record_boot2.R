...
## file name if saving
file_name = paste0("Simulation_dtrw_Xt_Rn_overT_norm_sd=",sd_obs,"_boot.xlsx")
...
if(save){
  ...
  save(list(final_combined_data, final_combined_data_record, boot_combined_data, boot_combined_data_record,All_Par, All_Par_record),
       file =  paste0(out_path,paste0("Simulation_dtrw_Xt_Rn_overT_norm_sd=",sd_obs,"_boot.rda")))
