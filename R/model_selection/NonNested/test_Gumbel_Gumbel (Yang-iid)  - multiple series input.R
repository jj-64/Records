...
true_gAa = c(1.2,1,1) ## true parameters were are generating mean and variance
summary = matrix(0, ncol=8, nrow=simulation)
...
summary[trial,] = as.numeric(c(param_H0_start[2:3],param_H1_start[2:3],CI))
}

colnames(summary) = c("H_0[1]", "H_0[2]", "H_1[1]", "H_1[2]","Gamma", "Lower", "Upper","Power")
